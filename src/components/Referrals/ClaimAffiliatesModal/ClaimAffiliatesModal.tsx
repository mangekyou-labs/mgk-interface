...
import { useMarkets } from "domain/legacy/hooks";
import { useAffiliateRewards, getTotalClaimableAffiliateRewardsUsd, claimAffiliateRewardsTxn } from "domain/synthetics/referrals/useAffiliateRewards";
