...
export const Exchange = forwardRef(
  (
    ...
    console.log("[Exchange Debug] Fetching token balances:", {
      active,
      chainId,
      readerAddress,
      account,
    ...
    console.log("[Exchange Debug] Token balances response:", {
    ...
    const { data: positionRouterApproved, mutate: mutatePositionRouterApproval } = useSWR(
    ...
    const approvePositionRouter = ({ sentMsg, failMsg }) => {
      ...
      return approvePlugin(chainId, positionRouterAddress, {
        ...
        .then(async (tx) => {
          ...
          await tx.wait();
          await mutatePositionRouterApproval();
        })
        .finally(() => {
