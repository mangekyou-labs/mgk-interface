import type { TokenCategory } from "domain/tokens";
import { Token } from "domain/tokens";
import { zeroAddress } from "viem";
import { ARBITRUM, AVALANCHE, AVALANCHE_FUJI, HEDERA, HEDERA_TESTNET } from "./chains";
  ...
  [HEDERA]: [
    {
      ...
      isShortable: true,
      categories: ["layer1"],
      imageUrl: "https://assets.coingecko.com/coins/images/3688/small/hbar.png?1547037959",
    ...
    },
    {
      ...
      symbol: "WHBAR",
      decimals: 18,
      address: "YOUR_WHBAR_ADDRESS", // Replace with actual WHBAR address
      isWrapped: true,
      baseSymbol: "HBAR",
      imageUrl: "https://assets.coingecko.com/coins/images/3688/small/hbar.png?1547037959",
      coingeckoUrl: "https://www.coingecko.com/en/coins/hedera",
    },
    {
      name: "USD Coin",
      symbol: "USDC",
      address: "YOUR_USDC_ADDRESS", // Replace with actual USDC address
      decimals: 6,
      isStable: true,
      imageUrl: "https://assets.coingecko.com/coins/images/6319/thumb/USD_Coin_icon.png?1547042389",
      coingeckoUrl: "https://www.coingecko.com/en/coins/usd-coin",
